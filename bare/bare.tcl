...
if { $list_projs eq "" } {
   create_project bare bare -part xc7z020clg400-1
}
...
proc create_root_design { parentCell } {
  ...
  # Create instance: psr_clk0_100MHz, and set properties
  set psr_clk0_100MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_clk0_100MHz ]

  # Create instance: psr_clk1_142MHz, and set properties
  set psr_clk1_142MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_clk1_142MHz ]

  # Create instance: psr_clk2_166MHz, and set properties
  set psr_clk2_166MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_clk2_166MHz ]

  # Create instance: psr_clk3_200MHz, and set properties
  set psr_clk3_200MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_clk3_200MHz ]

  # Create instance: psr_clk4_50MHz, and set properties
  set psr_clk4_50MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_clk4_50MHz ]

  # Create instance: psr_clk5_41MHz, and set properties
  set psr_clk5_41MHz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr_clk5_41MHz ]
  ...
  connect_bd_intf_net -intf_net ps7_axi_periph_M00_AXI [get_bd_intf_pins axi_vip_0/S_AXI] [get_bd_intf_pins ps7_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_vip_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ps7/M_AXI_GP0_ACLK] [get_bd_pins ps7_axi_periph/ACLK] [get_bd_pins ps7_axi_periph/M00_ACLK] [get_bd_pins ps7_axi_periph/S00_ACLK] [get_bd_pins psr_clk0_100MHz/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins psr_clk1_142MHz/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins psr_clk2_166MHz/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out4 [get_bd_pins clk_wiz_0/clk_out4] [get_bd_pins psr_clk3_200MHz/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out5 [get_bd_pins clk_wiz_0/clk_out5] [get_bd_pins psr_clk4_50MHz/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out6 [get_bd_pins clk_wiz_0/clk_out6] [get_bd_pins psr_clk5_41MHz/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins psr_clk0_100MHz/dcm_locked] [get_bd_pins psr_clk1_142MHz/dcm_locked] [get_bd_pins psr_clk2_166MHz/dcm_locked] [get_bd_pins psr_clk3_200MHz/dcm_locked] [get_bd_pins psr_clk4_50MHz/dcm_locked] [get_bd_pins psr_clk5_41MHz/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins ps7_axi_periph/ARESETN] [get_bd_pins psr_clk0_100MHz/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_vip_0/aresetn] [get_bd_pins ps7_axi_periph/M00_ARESETN] [get_bd_pins ps7_axi_periph/S00_ARESETN] [get_bd_pins psr_clk0_100MHz/peripheral_aresetn]
  connect_bd_net -net ps7_FCLK_CLK0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps7/FCLK_CLK0]
  connect_bd_net -net ps7_FCLK_RESET0_N [get_bd_pins clk_wiz_0/resetn] [get_bd_pins ps7/FCLK_RESET0_N] [get_bd_pins psr_clk0_100MHz/ext_reset_in] [get_bd_pins psr_clk1_142MHz/ext_reset_in] [get_bd_pins psr_clk2_166MHz/ext_reset_in] [get_bd_pins psr_clk3_200MHz/ext_reset_in] [get_bd_pins psr_clk4_50MHz/ext_reset_in] [get_bd_pins psr_clk5_41MHz/ext_reset_in]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps7/Data] [get_bd_addr_segs axi_vip_0/S_AXI/Reg] -force
  ...
  set_property PFM.CLOCK { \
	clk_out1 {id "0" is_default "true" \
		proc_sys_reset "psr_clk0_100MHz" status "fixed"} \
	clk_out2 {id "1" is_default "false" \
		proc_sys_reset "psr_clk1_142MHz" status "fixed"} \
	clk_out3 {id "2" is_default "false" \
		proc_sys_reset "psr_clk2_166MHz" status "fixed"} \
	clk_out4 {id "3" is_default "false" \
		proc_sys_reset "psr_clk3_200MHz" status "fixed"} \
	clk_out5 {id "4" is_default "false" \
		proc_sys_reset "psr_clk4_50MHz" status "fixed"} \
	clk_out6 {id "5" is_default "false" \
		proc_sys_reset "psr_clk5_41MHz" status "fixed"} \
  } [get_bd_cells /clk_wiz_0]
  set gp0Val []
  for {set i 1} {$i < 16} {incr i} {
    lappend gp0Val M[format %02d $i]_AXI {memport "M_AXI_GP" sptag "" memory ""}
  }
  set_property PFM.AXI_PORT $gp0Val [get_bd_cells /ps7_axi_periph]
