...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net interconnect_axilite_M00_AXI [get_bd_intf_pins axi_register_slice_1/S_AXI] [get_bd_intf_pins interconnect_axilite/M00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins axi_register_slice_1/aclk] [get_bd_pins clk_wiz_0/clk_out3] [get_bd_pins interconnect_axilite/ACLK] [get_bd_pins interconnect_axilite/M00_ACLK] [get_bd_pins interconnect_axilite/S00_ACLK] [get_bd_pins ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins psr_clk2_75/slowest_sync_clk]
  ...
  connect_bd_net -net psr_clk1_300_peripheral_aresetn [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins psr_clk1_300/peripheral_aresetn]
  connect_bd_net -net psr_clk2_75_peripheral_aresetn [get_bd_pins axi_register_slice_1/aresetn] [get_bd_pins psr_clk2_75/peripheral_aresetn]
