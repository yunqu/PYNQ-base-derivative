...
if { $list_projs eq "" } {
   create_project ultra ultra -part xczu3eg-sbva484-1-i
}
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {249.997500} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR0 {6} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__DIVISOR1 {1} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__FREQMHZ {100} \
   CONFIG.PSU__CRL_APB__PL2_REF_CTRL__SRCSEL {IOPLL} \
   CONFIG.PSU__CRL_APB__PL3_REF_CTRL__ACT_FREQMHZ {299.997000} \
  ...
  set_property PFM_NAME {xilinx.com:xd:ultra:1.0} [get_files [current_bd_design].bd]
